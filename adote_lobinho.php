...
<body>
    ...
    <section id=adote>
        <section class="adote-um-lobinho">
            <div class="imagem_nome">
                <figure class="lobo_image"></figure>
                <div class="Nome_id">
...
<footer>
    ...
    <div class="pata"><p>Desenvolvido com</p><img src="./img/paws.svg" alt=""></div>
</footer>